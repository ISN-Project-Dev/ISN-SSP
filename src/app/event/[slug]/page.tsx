    ...
    <>
      <div className="relative w-full">
        <Image
          ...
          height={200}
        />
        <h2 className="absolute inset-0 flex items-center justify-center text-[#192f59] text-3xl font-bold bg-blue-50/30">Event Details</h2>
      </div>
      <section className="mt-10 md:mt-16 mb-20 flex flex-col min-h-screen items-center">
        ...
        <div className="w-full max-w-7xl px-10 space-y-5 my-10">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
            <h1 className="text-2xl text-[#192f59] font-bold">{eventIdData?.title}</h1>
          ...
          <p className="text-semibold text-[#2f4369]">{eventIdData?.description}</p>
        </div>
        <div className=" px-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl w-full">
          {[
            ...
            >
              ...
              <p className="text-[#2f4369]">{item.value || "Not provided"}</p>
            </div>
          ))}
        </div>
