    ...
    <footer className="bg-[#192f59] text-white py-10 px-6">
      <div className="max-w-[1440px] mx-auto flex flex-col gap-10 md:flex-row md:justify-between">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          />
          <p className="max-w-sm text-sm leading-relaxed">The SKS Student Portal is a dedicated platform established to promote student involvement in sports and co-curricular activities, fostering holistic development through organized events and official recognition.</p>
        </div>
